...
public class StanfordChineseNlpExample
{
    public static void main(String[] args) throws Exception {
        ...
        String text = "叶凌：　　经查，你隐瞒了在南平市建阳区莒口镇生态保护工作站工作的事实，存在提供虚假材料，以欺骗手段取得二级建造师注册证书的行为。本厅于2017年9月8日作出《福建省住房和城乡建设厅撤销行政许可告知书》（闽建许函〔2017〕92号），并于2017年9月20日送达给你，你在规定的期限内未向本厅提出书面陈述、申辩。　　根据《中华人民共和国行政许可法》第六十九条、第七十九条和《注册建造师管理规定》第三十四条规定，本厅决定撤销对你作出的二级建造师注册许可，自作出撤销决定之日";
